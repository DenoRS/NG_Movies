...
class GetPopularMoviesUseCaseTest {
    ...
    @BeforeEach
    fun setUp() {
        classUnderTest = GetPopularMoviesUseCase(repository, testDispatcher)
    }
    ...
    @DisplayName(
        """
            ...
            THEN I expect a list of most popular movies to be returned
        """
    )
    fun testReturnsMostPopularMovies() = testScope.runTest {
        // GIVEN
        val page = 1
        ...
        coEvery { repository.getPopularMovies(page) } returns expectedMovies
    ...
    fun testReturnsEmptyList() = testScope.runTest {
        // GIVEN
        val page = 2
        coEvery { repository.getPopularMovies(page) } returns emptyList()
    ...
    fun testThrowsException() = testScope.runTest {
        ...
        coEvery { repository.getPopularMovies(page) } throws exception
